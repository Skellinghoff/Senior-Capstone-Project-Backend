...
export default class AuthController {
    static async azureGetSignin(req, res, next) {
    ...
    static async azureGetAcquireToken(req, res, next) {
    ...
    static async azurePostRedirect(req, res, next) {
        if (req.body.state) {
    ...
    static azureGetSignout(req, res) {
        /**
